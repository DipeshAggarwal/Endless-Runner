...
public class Player : MonoBehaviour
{
    ...
    private IEnumerator hurtVFXRoutine()
    {
        ...
        Color lightenColor = new Color(sr.color.r, sr.color.g, sr.color.b, 0.5f);

        sr.color = lightenColor;
    ...
    public void hurtVFX()
    {
        // Stops coroutine when it's done.
        if (hurtAnimCoroutine != null)
        {
            StopCoroutine(hurtAnimCoroutine);
        }

        // Assign a new Coroutine when it's called.
